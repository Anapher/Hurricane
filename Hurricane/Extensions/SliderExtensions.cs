...
namespace Hurricane.Extensions
{
    public class SliderExtensions
    {
        ...
        public static readonly DependencyProperty MoveToPointOnDragProperty = DependencyProperty.RegisterAttached("MoveToPointOnDrag", typeof(bool), typeof(SliderExtensions), new PropertyMetadata
        {
